<template>
  <div v-if="visible" class="guest-mode-banner" role="banner" :style="{ background: 'var(--hula-color-warning-100)' }">
    <div class="guest-mode-banner__content">
      <svg class="guest-mode-banner__icon" width="20" height="20" viewBox="0 0 24 24" fill="none">
        <path
          d="M12 2L2 22h20L12 2z"
          stroke="var(--hula-color-warning-500)"
          stroke-width="2"
          stroke-linejoin="round"
          fill="var(--hula-color-warning-100)" />
        <line
          x1="12"
          y1="9"
          x2="12"
        ...
        <circle cx="12" cy="17.5" r="1.2" fill="var(--hula-color-warning-500)" />
      </svg>
...
.guest-mode-banner {
  ...
  gap: 12px;
  padding: 8px 16px;
  border-bottom: 1px solid var(--hula-color-warning-400);
}
