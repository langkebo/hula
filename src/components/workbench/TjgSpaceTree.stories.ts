...
const meta = {
  title: 'Components/Workbench/TjgSpaceTree',
  component: TjgSpaceTree,
  parameters: {
    layout: 'fullscreen'
  },
  args: {
    ...
    defineComponent({
      ...
      template: `
        <div :style="storyFrameStyle">
          <div style="padding: 12px; border-bottom: 1px solid var(--tjg-border-default); font-size: 12px; color: var(--tjg-text-tertiary);">
...
} satisfies Meta<typeof TjgSpaceTree>
