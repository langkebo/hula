...
.result-item {
  ...
  &--selected {
    background: var(--tjg-color-primary-100, color-mix(in srgb, var(--tjg-color-primary-500) 12%, transparent));
  }
}
...
.btn--secondary {
  ...
  &:hover {
    background: var(--tjg-surface-list-active, var(--tjg-surface-list-hover));
  }
}
