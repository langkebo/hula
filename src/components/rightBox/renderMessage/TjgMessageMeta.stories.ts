...
const meta = {
  title: 'Components/RightBox/TjgMessageMeta',
  component: TjgMessageMeta,
  parameters: {
    layout: 'fullscreen'
  },
  args: {
      ...
      template: `
        <div :style="storyFrameStyle">
          <div style="padding: 12px;">
            <TjgMessageMeta v-bind="args" />
          </div>
        </div>
      `
    })
} satisfies Meta<typeof TjgMessageMeta>
