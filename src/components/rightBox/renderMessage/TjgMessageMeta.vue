<template>
  <div class="tjg-message-meta" :class="{ 'is-me': isMe }">
    <div class="meta-row">
...
const formattedTime = computed(() => formatChatTime(props.timestamp))
...
.retry-button:hover {
  color: var(--tjg-color-danger-600, var(--tjg-color-danger-500));
}
