...
// biome-ignore lint/style/useImportType: SFC is used in <template> at runtime (session list), must stay a runtime import
...
// 若放在 onMounted 的 await 之后，getCurrentInstance() 返回 null，onUnmounted 静默失效导致内存泄漏。
