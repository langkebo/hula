    ...
    <n-flex vertical class="text-(14px [--text-color])" :size="16">
      ...
      <n-flex class="item p-12px" :size="12" vertical>
            ...
            <n-flex align="center" justify="space-between" class="py-12px">
              <n-flex align="center" :size="12">
                ...
                <n-flex vertical :size="4">
                  ...
                  <span class="text-(12px #909090) truncate max-w-300px">{{ device.ip_address }}</span>
                </n-flex>
              </n-flex>
        ...
        <n-flex justify="space-between" align="center">
          <span class="text-(12px #909090)">{{ devices.length }} {{ t('setting.sessions.devices') }}</span>
            ...
            <n-flex align="center" justify="space-between" class="py-8px">
              <n-flex align="center" :size="12">
                <div class="device-icon-small">
                  <svg class="size-16px"><use :href="record.device_type === 'desktop' ? '#computer' : '#phone'"></use></svg>
                </div>
