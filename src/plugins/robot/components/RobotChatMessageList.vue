  ...
  <div class="chat-messages-container w-full box-border flex flex-col">
    <div
      ...
      <div ref="messageContentRef" class="p-[16px_16px] box-border">
        ...
        <div v-if="loadingMessages" class="flex justify-center items-center py-20px text-(12px [--tjg-text-tertiary])">
          <n-spin size="small" />
          ...
          <div class="flex items-start gap-10px" :class="message.type === 'user' ? 'flex-row-reverse' : ''">
            ...
            <n-flex vertical :size="6" class="flex-1" :class="message.type === 'user' ? 'items-end' : 'items-start'">
              <n-flex
                align="center"
                :size="8"
                class="select-none text-(12px [--tjg-text-tertiary])"
                  ...
                  <template v-else>
                    <div class="flex flex-col gap-8px">
                      <div
                        ...
                        class="reasoning-content p-12px rounded-8px bg-[--tjg-surface-panel-muted] dark:bg-[--tjg-surface-subtle] border-(1px solid [--tjg-border-default])">
                        <div class="flex items-center gap-6px mb-8px">
                          <Icon icon="mdi:brain" class="text-16px text-[--tjg-color-info-500]" />
                          <span class="text-12px text-[--tjg-text-tertiary] font-500">
...
:deep(.link-node),
:deep(.footnote-link) {
  --link-color: var(--tjg-color-primary-500);
