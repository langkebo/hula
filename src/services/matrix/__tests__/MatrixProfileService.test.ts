...
describe('ProfileService', () => {
  ...
  describe('getDisplayName', () => {
    it('should throw error when client is not initialized', async () => {
      const service = new (profileService.constructor as any)()
      await expect(service.getDisplayName('@user:matrix.org')).rejects.toThrow('Client 未初始化')
    })
  ...
  describe('getAvatarUrl', () => {
    it('should throw error when client is not initialized', async () => {
      const service = new (profileService.constructor as any)()
      await expect(service.getAvatarUrl('@user:matrix.org')).rejects.toThrow('Client 未初始化')
    })
