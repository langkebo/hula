...
describe('SettingStore', () => {
  beforeEach(() => {
    ...
    pinia.use(createPersistedState({ auto: false }))
  ...
  describe('preference actions', () => {
    ...
    it('migrateLegacyPreferenceSettings migrates legacy localStorage keys once', () => {
      const store = useSettingStore()
      localStorage.setItem('tjg-message-confirm', 'true')
      localStorage.setItem('tjg-link-preview', 'false')
      localStorage.setItem('tjg-emoji-convert', 'false')
      localStorage.setItem('tjg-emoji-size', 'large')
      localStorage.setItem('tjg-burn-default-enabled', 'true')
      localStorage.setItem('tjg-burn-default-duration', '300')
      localStorage.setItem('tjg-burn-show-countdown', 'false')
      localStorage.setItem('tjg-thread-auto-subscribe', 'false')
      localStorage.setItem('tjg-thread-show-in-room', 'false')
      localStorage.setItem('tjg-thread-notification-level', 'all')
      localStorage.setItem('tjg-space-auto-join', 'true')
      localStorage.setItem('tjg-space-show-subspaces', 'false')
      localStorage.setItem('tjg-space-default-notification', 'mentions_only')
      localStorage.setItem('tjg-send-read-receipts', 'false')
      localStorage.setItem('tjg-send-typing-notifications', 'false')
      ...
      expect(store.sendReadReceiptsEnabled).toBe(false)
      expect(store.sendTypingNotificationsEnabled).toBe(false)
      expect(localStorage.getItem('tjg-message-confirm')).toBeNull()
      expect(localStorage.getItem('tjg-link-preview')).toBeNull()
      expect(localStorage.getItem('tjg-emoji-convert')).toBeNull()
      expect(localStorage.getItem('tjg-emoji-size')).toBeNull()
      expect(localStorage.getItem('tjg-burn-default-enabled')).toBeNull()
      expect(localStorage.getItem('tjg-burn-default-duration')).toBeNull()
      expect(localStorage.getItem('tjg-burn-show-countdown')).toBeNull()
      expect(localStorage.getItem('tjg-thread-auto-subscribe')).toBeNull()
      expect(localStorage.getItem('tjg-thread-show-in-room')).toBeNull()
      expect(localStorage.getItem('tjg-thread-notification-level')).toBeNull()
      expect(localStorage.getItem('tjg-space-auto-join')).toBeNull()
      expect(localStorage.getItem('tjg-space-show-subspaces')).toBeNull()
      expect(localStorage.getItem('tjg-space-default-notification')).toBeNull()
      expect(localStorage.getItem('tjg-send-read-receipts')).toBeNull()
      expect(localStorage.getItem('tjg-send-typing-notifications')).toBeNull()
    })
  })
