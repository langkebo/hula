...
import type { Report, ReportFilters, UserReputation, ContentFilter } from '@/services/matrix/MatrixModerationService'
import { info, error } from '@tauri-apps/plugin-log'

export const useModerationStore = defineStore(StoresEnum.MODERATION, () => {
  const reports = ref<Report[]>([])
  const userReputations = ref<Map<string, UserReputation>>(new Map())
