...
- 设置页主壳层、搜索关键词、移动端阅后即焚时长文案、扫码页关键提示以及部分资料编辑/AI 助手反馈文案已显著收敛，但设置体系其余日志、错误提示与辅助文案仍未完成统一。
