...
public class SecureInvokeService {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(SecureInvokeService.class);
    ...
    public SecureInvokeService(SecureInvokeRecordDao secureInvokeRecordDao, Executor executor) {
        this.secureInvokeRecordDao = secureInvokeRecordDao;
