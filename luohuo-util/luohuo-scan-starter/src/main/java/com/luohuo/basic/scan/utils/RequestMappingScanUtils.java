...
public class RequestMappingScanUtils {
    ...
    public void scan(String scanBase, ApplicationContext applicationContext) {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> m : map.entrySet()) {
            ...
            SystemApiVO api = new SystemApiVO();
            api.setName(name);
            api.setRequestMethod(requestMethod);
            api.setSpringApplicationName(springApplicationName);
            api.setUri(servicePath + uri);
    ...
    public Map<String, List<SystemApiVO>> getRequestMappingMap() { return requestMappingMap; }
}
