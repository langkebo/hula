...
public class LuohuoFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LuohuoFeignClientsRegistrar.class);
    ...
    private void registerFeignClients(BeanDefinitionRegistry registry) {
        List<String> feignClients = SpringFactoriesLoader.loadFactoryNames(getSpringFactoriesLoaderFactoryClass(), this.beanClassLoader);
