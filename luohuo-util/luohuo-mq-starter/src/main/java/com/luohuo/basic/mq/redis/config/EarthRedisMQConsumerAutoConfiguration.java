...
import com.luohuo.basic.mq.redis.core.job.RedisPendingMessageResendJob;
...
public class EarthRedisMQConsumerAutoConfiguration {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(EarthRedisMQConsumerAutoConfiguration.class);
