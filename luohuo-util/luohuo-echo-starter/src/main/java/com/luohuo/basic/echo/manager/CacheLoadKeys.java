...
public class CacheLoadKeys {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(CacheLoadKeys.class);
    ...
    public Set<Serializable> getKeys() { return keys; }
    public LoadService getLoadService() { return loadService; }
