    ...
    public SseEmitter translateStream(@RequestParam String text,
        ...
        try {
            ...
            for (String seg : segments) {
                ...
                try { Thread.sleep(Duration.ofMillis(120).toMillis()); } catch (InterruptedException e) { log.warn("Interrupted", e); Thread.currentThread().interrupt(); }
            }
            ...
            } catch (IOException e) { log.warn("IO error sending SSE", e); }
