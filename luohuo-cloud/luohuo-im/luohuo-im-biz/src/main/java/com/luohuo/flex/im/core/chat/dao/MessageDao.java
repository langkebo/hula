...
public class MessageDao extends ServiceImpl<MessageMapper, Message> {
     ...
     * 关联普通消息与加密消息
     */
    public boolean linkEncryptedMessage(Long normalMsgId, Long encryptedMsgId) {
        return lambdaUpdate()
            .eq(Message::getId, normalMsgId)
            .set(Message::getIsEncrypted, true)
            .set(Message::getEncryptedMsgId, encryptedMsgId)
            .update();
    }
}
