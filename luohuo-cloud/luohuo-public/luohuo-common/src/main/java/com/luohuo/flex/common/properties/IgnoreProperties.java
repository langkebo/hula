...
public class IgnoreProperties {
    ...
    public Map<String, Set<String>> getBaseUri() { return baseUri; }
    public Map<String, Set<String>> getAnyTenant() { return anyTenant; }
    public Map<String, Set<String>> getAnyUser() { return anyUser; }
    public Map<String, Set<String>> getAnyone() { return anyone; }
    public Boolean getAuthEnabled() { return authEnabled; }
    public Boolean getNotConfigUriAllow() { return notConfigUriAllow; }
