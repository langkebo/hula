...
public interface MqConstant {
     ...
     * E2EE加密消息发送
     */
    String E2EE_MSG_SEND_TOPIC = "chat_private_encrypted_send";
    String E2EE_MSG_SEND_GROUP = "chat_private_encrypted_send_group";

    /**
     * E2EE消息ACK确认
     */
    String E2EE_MSG_ACK_TOPIC = "chat_private_ack";
    String E2EE_MSG_ACK_GROUP = "chat_private_ack_group";

    /**
     * E2EE密钥轮换事件
     */
    String E2EE_KEY_ROTATE_TOPIC = "e2ee_key_rotate";
    String E2EE_KEY_ROTATE_GROUP = "e2ee_key_rotate_group";

    /**
     * E2EE会话密钥分发事件
     */
    String E2EE_SESSION_KEY_TOPIC = "e2ee_session_key_distribute";
    String E2EE_SESSION_KEY_GROUP = "e2ee_session_key_distribute_group";

    /**
     * E2EE消息已读通知
     */
    String E2EE_MSG_READ_TOPIC = "e2ee_message_read";
    String E2EE_MSG_READ_GROUP = "e2ee_message_read_group";

    /**
     * E2EE消息销毁通知
     */
    String E2EE_MSG_DESTRUCT_TOPIC = "e2ee_message_destruct";
    String E2EE_MSG_DESTRUCT_GROUP = "e2ee_message_destruct_group";
}
