...
public class MySaTokenContextRegister {
    private static final Logger log = LoggerFactory.getLogger(MySaTokenContextRegister.class);
    ...
    public static class InnerConfig {
        private static final Logger log = LoggerFactory.getLogger(InnerConfig.class);
        public InnerConfig() {
