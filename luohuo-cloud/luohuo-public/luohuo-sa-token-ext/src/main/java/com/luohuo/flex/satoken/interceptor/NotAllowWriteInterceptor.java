...
public class NotAllowWriteInterceptor implements AsyncHandlerInterceptor {
    ...
    private static final Logger log = LoggerFactory.getLogger(NotAllowWriteInterceptor.class);

    public NotAllowWriteInterceptor(SystemProperties systemProperties) {
