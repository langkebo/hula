...
public interface AppendixService extends SuperManager<Appendix> {
    ...
    default AppendixBizKey buildBiz(Long bizId, String bizType) {
        return new AppendixBizKey(bizId, bizType);
    }
    ...
    class AppendixBizKey implements Serializable {
        ...
        public AppendixBizKey(Long bizId, String bizType) {
            this.bizId = bizId;
        ...
        public boolean equals(Object o) {
            ...
            AppendixBizKey that = (AppendixBizKey) o;
            return java.util.Objects.equals(bizId, that.bizId) && java.util.Objects.equals(bizType, that.bizType);
        }

        @Override
        public int hashCode() {
            return java.util.Objects.hash(bizId, bizType);
        }
    }
}
