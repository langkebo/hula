...
public class GateController {
    ...
    public R<List<Option>> findOnlineService() {
        ...
        list.add(new Option("luohuo-base", application, "base", null));
        list.add(new Option("luohuo-system", application, "system", null));
        list.add(new Option("luohuo-generator", application, "generator", null));
